      ...
      <div className="w-[50%]  ">
        ...
        <div className="w-[90%] flex flex-row justify-between items-center mt-16">
          <div className="w-[346px] h-[104px] flex justify-center items-center border-[2.5px] border-[#F29AA7] rounded-[10px] relative ">
            ...
            <input
              ...
              className="w-full h-full text-[37px] pl-4 font-light placeholder:text-[#C0C0C0] placeholder:font-light  rounded-[10px] focus:outline-none"
            />
          </div>
          <div className="w-[346px] h-[104px] flex justify-center items-center border-[2.5px] border-[#F29AA7] rounded-[10px] relative ">
            <p className="text-[48px] font-medium absolute bottom-16 left-5  bg-white">
        ...
        <div className="w-[90%] h-[231px] mt-14 flex flex-col-reverse border-[2.5px] border-[#F29AA7] rounded-[10px] relative">
          ...
          <textarea
            ...
            id=""
            className="w-full h-[85%] focus:outline-none placeholder:text-[37px] text-[37px] placeholder:font-light pl-4 placeholder:text-[#C0C0C0] "
          ></textarea>
        </div>
        <div className="w-[90%] h-[65px] flex flex-col items-center">
          <button className="bg-[#F29AA7] w-[232px] h-[65px] text-[45px] mt-12 mx-auto text-white rounded-[23px] ">
            send
          </button>
        </div>
      </div>
