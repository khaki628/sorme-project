      ...
      <div className="w-full flex flex-row ">
        ...
        <div className="w-[1251px] h-[600px] flex flex-row items-center justify-around rounded-[20px] bg-[#FFF0F3] mx-auto mt-32 ">
          <div className="w-[402px] h-[533px] bg-white flex flex-col items-center rounded-[20px]">
            ...
            <div className="w-[95%] h-[370px] mt-7 flex flex-col-reverse border-[2.5px] border-[#F29AA7] rounded-[10px] relative">
              <p className="text-[16px] font-semibold absolute bottom-[360px] left-5 bg-white ">
                your massage
              </p>
              <textarea
                name="your_massage"
                ...
                id=""
                className="w-full h-full focus:outline-none text-[24px] placeholder:font-light pl-2 placeholder:text-[#C0C0C0] "
              ></textarea>
            </div>
            <button className="w-[171px] h-[40px] text-white text-[32px] flex items-center justify-center bg-[#F29AA7] rounded-[23px] mt-4">
              Send
            </button>
          </div>
